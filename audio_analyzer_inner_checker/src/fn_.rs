pub fn analyzer(wav_file: &mut audio_analyzer_core::prelude::TestData, sample_rate: u32) {
    ...
    loop {
        ...
        let out_19_0 = {
            let (0usize, 1usize, 10usize) = (0usize as usize, 1usize as usize, 10usize as usize);
        ...
        let out_22_0 = {
            let (0usize, 1usize, out_3_0) = (0usize as usize, 1usize as usize, out_3_0 as usize);
        ...
        let tmp_ExprNodes_25 = {
            ...
            if is_first_longer {
                out_4_0
                    ...
                    .into_iter()
                    .zip(out_23_0.into_iter())
                    .collect::<ndarray::Array1<(f64, f64)>>()
            } else {
                out_4_0
                    .slice_move(ndarray::s![..out_4_0.len()])
                    .into_iter()
                    .zip(out_4_0.into_iter())
                    .collect::<ndarray::Array1<(f64, f64)>>()
            }
        };
        let out_25_0 = {
